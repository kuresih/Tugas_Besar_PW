...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="index.html">PUISIku</a>
      ...
      <ul class="sidebar navbar-nav">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu" aria-labelledby="pagesDropdown">
            <a class="dropdown-item" href="login.html">Romance</a>
            <a class="dropdown-item" href="register.html">Islami</a>
            <a class="dropdown-item" href="forgot-password.html">Pendidikan</a>
            <div class="dropdown-divider"></div>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Buatpuisibaru.html">
            <span>Tulis Puisi Baru</span></a>
        </li>
      </ul>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a class="btn btn-primary" href="logiin.php">Logout</a>
          </div>
        </div>
      </div>
    </div>
