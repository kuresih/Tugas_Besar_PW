    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <li class="nav-item active">
        <a class="nav-link" href="#">Ciptakan <span class="sr-only">(current)</span></a>
      </li>
        </div>
      </li>
    </ul>
...
<?php
  ...
  <h5 class="card-header">Judul : <?php echo $data['judul'];?></h5>
    <h5 class="card-header">Nama Penulis : <?php echo $data['nama_penulis'];?></h5>
    <p class="card-header">Kategori : <?php echo $data['kategori'];?></p>
    <div class="card-body">
    <p class="card-text"><?php echo $data['isi_puisi'];?></p>
    
  </div>
</div>
    <!--  $data['judul']."<br>".$data['nama_penulis']."<br>". $data['kategori']."<br>".$data['isi_puisi'];
    echo "<br>"; --><?php
  }
?>
